...
const HAIR_SCENES: Array = [
	null,
	preload("res://assets/modules/hair/Hair_SimpleParted.gltf"),
	preload("res://assets/modules/hair/Hair_Buzzed.gltf"),
	preload("res://assets/modules/hair/Hair_Long.gltf"),
	preload("res://assets/modules/hair/Hair_Buns.gltf"),
	preload("res://assets/modules/hair/Lowpoly_Male_Hair.tscn"),
	preload("res://assets/modules/hair/Lowpoly_Short_Hair_1.tscn"),
	preload("res://assets/modules/hair/Lowpoly_Ponytail.tscn"),
	preload("res://assets/modules/hair/Lowpoly_Short_Hair_2.tscn"),
	preload("res://assets/modules/hair/Lowpoly_Cap_Hair.tscn"),
	preload("res://assets/modules/hair/Capsule_Female_Hair.tscn"),
	preload("res://assets/modules/hair/Capsule_Male_Hair.tscn"),
]
const FACIAL_HAIR_SCENES: Array = [
	null,
	preload("res://assets/modules/hair/Lowpoly_Full_Beard.tscn"),
	preload("res://assets/modules/hair/Lowpoly_Moustache.tscn"),
	preload("res://assets/modules/hair/Lowpoly_Beard.tscn"),
	preload("res://assets/modules/hair/Quaternius_Beard.tscn"),
]
...
const HAT_SCENES: Array = [
	null,
	preload("res://assets/modules/headwear/Male_Ranger_Head_Hood.gltf"),
	preload("res://assets/modules/headwear/Female_Ranger_Head_Hood.gltf"),
	null,
	null,
	preload("res://assets/modules/headwear/Lowpoly_Cap.tscn"),
	preload("res://assets/modules/headwear/Lowpoly_Cap_With_Hair.tscn"),
	preload("res://assets/modules/headwear/Lowpoly_Round_Hat.tscn"),
	preload("res://assets/modules/headwear/Capsule_Cap.tscn"),
]
const SHIRT_GRAPHICS: Array[Texture2D] = [
	null,
	preload("res://assets/modules/graphics/skull.svg"),
	preload("res://assets/modules/graphics/heart.svg"),
	preload("res://assets/modules/graphics/star.svg"),
	preload("res://assets/modules/graphics/lightning.svg"),
	preload("res://assets/modules/graphics/flame.svg"),
	preload("res://assets/modules/graphics/flower.svg"),
	preload("res://assets/modules/graphics/cat.svg"),
	preload("res://assets/modules/graphics/moon.svg"),
	preload("res://assets/modules/graphics/burger.svg"),
	preload("res://assets/modules/graphics/crown.svg"),
]
const GLASSES_SCENES: Array = [
	null,
	preload("res://assets/sourced/glasses/glasses1.001.fbx"),
	preload("res://assets/sourced/glasses/glasses2.001.fbx"),
	preload("res://assets/sourced/glasses/glasses3.001.fbx"),
	preload("res://assets/sourced/glasses/glasses4.001.fbx"),
	preload("res://assets/sourced/glasses/glasses5.003.fbx"),
	preload("res://assets/sourced/glasses/glasses8.001.fbx"),
	preload("res://assets/sourced/glasses/glasses11.001.fbx"),
	preload("res://assets/sourced/glasses/glasses14.001.fbx"),
	preload("res://assets/sourced/glasses/glasses20.001.fbx"),
	preload("res://assets/sourced/glasses/glasses29.001.fbx"),
]
...
func _apply_skin_material() -> void:
	...
	if _skin_material == null:
		_skin_material = _toon_material(skin_color)
		_skin_material.resource_name = "Toon Skin"
	_skin_material.albedo_color = skin_color
	for child in toon_body.find_children("*", "MeshInstance3D", true, false):
		var mesh := child as MeshInstance3D
		# Only the original weighted body receives skin-tone changes.
		if mesh.skin != null:
...
func _create_head_modules() -> void:
	...
	var inherited_scale := _head_attachment.global_transform.basis.get_scale().x
...
func _build_mouth() -> void:
	if _mouth_root == null:
		return
	_clear(_mouth_root)
	var mouth_material := _toon_material(mouth_color)
	mouth_material.cull_mode = BaseMaterial3D.CULL_DISABLED
	mouth_material.shading_mode = BaseMaterial3D.SHADING_MODE_UNSHADED
	var mouth_position_y := mouth_vertical
	if mouth_style == MouthStyle.SMILE:
		_add_half_disc(_mouth_root, "HalfCircleMouth", Vector3(0.0, 0.105 + mouth_position_y, 0.472 + mouth_depth), Vector2(0.27 * mouth_width, 0.13 * mouth_height), 0.025, mouth_material)
	elif mouth_style == MouthStyle.FLAT:
		_add_box(_mouth_root, "FlatMouth", Vector3(0.0, 0.07 + mouth_position_y, 0.452 + mouth_depth), Vector3(0.28 * mouth_width, 0.035 * mouth_height, 0.045), mouth_material)
	else:
		_add_sphere(_mouth_root, "OpenMouth", Vector3(0.0, 0.08 + mouth_position_y, 0.455 + mouth_depth), Vector3(0.11 * mouth_width, 0.14 * mouth_height, 0.026), mouth_material)
