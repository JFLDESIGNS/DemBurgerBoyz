...
const TRY2_GLB_FILES: PackedStringArray = [
	...
	"SM_BaconCooked.glb",
	"SM_BaconRaw.glb",
	"SM_BurgerBoxClosed.glb",
	"SM_BurgerBoxOpen.glb",
	"SM_BurgerBunBurntBottom.glb",
	"SM_BurgerBunBurntTop.glb",
	"SM_BurgerBunBurntTopSeeds.glb",
	"SM_BurgerBunToastedBottom.glb",
	"SM_BurgerBunToastedTop.glb",
	"SM_BurgerBunToastedTopSeeds.glb",
	"SM_BurgerBunUntoastedBottom.glb",
	"SM_BurgerBunUntoastedTop.glb",
	"SM_BurgerBunUntoastedTopSeeds.glb",
	"SM_BurgerPackagingPaper.glb",
	"SM_BurgerPattyBurned.glb",
	"SM_BurgerPattyBurnedCutA.glb",
	"SM_BurgerPattyBurnedCutB.glb",
	"SM_BurgerPattyGrilled.glb",
	"SM_BurgerPattyGrilledCutA.glb",
	"SM_BurgerPattyGrilledCutB.glb",
	"SM_BurgerPattyRaw.glb",
	"SM_BurgerPattyRawBall.glb",
	"SM_BurgerPressBottom.glb",
	"SM_BurgerPressTop.glb",
	"SM_CheeseSlice.glb",
	"SM_CheeseSliceMelted.glb",
	"SM_CheeseSliceMelting.glb",
	"SM_ChefsKnife.glb",
	"SM_FastFoodBagClosed.glb",
	"SM_FastFoodBagCrumpled.glb",
	"SM_FastFoodBagOpen.glb",
	"SM_GrillPress.glb",
	"SM_GrillSpatula.glb",
	"SM_KetchupSauce.glb",
	"SM_KetchupSqueezeBottle.glb",
	"SM_LettuceLeaf.glb",
	"SM_MustardSauce.glb",
	"SM_MustardSqueezeBottle.glb",
	"SM_OnionARingA.glb",
	"SM_OnionARingB.glb",
	"SM_OnionASlice.glb",
	"SM_OnionBRingA.glb",
